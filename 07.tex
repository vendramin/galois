...
$L/K$ is normal, as $L/K$ is a splitting field of the family $\{f(x,K):x\in S\}$. 
...
\begin{proof}
    ...
    Thus $f_x\in K[X]$
    and $E/K$ is a splitting field of the family $\{f_x:x\in E\}$. In particular, 
...
\begin{proposition}
    ...
    if and only if $E$ is a splitting field over $K$ 
...
\begin{proof}
    ...
    Then $E/K$ is a splitting field of $f(x,K)$ since
...
\begin{proof} 
    Let $C/K$ be an algebraic closure such that $E\subseteq C$. Let $\sigma\in\Hom(F/K,C/K)$, and let $\varphi\in\Hom(E/K,C/K)$ be such that $\varphi|_F=\sigma$. Since $E/K$ is normal, 
